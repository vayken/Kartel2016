...
<section id="main_page" style="height: 750px;">
	<br/>

	<pre> </pre><pre style="color: rgb(128, 175, 16); text-decoration:line-through;">                </pre>
	<span style="color: rgb(128, 175, 16);">Vos avis !</span>
	<pre style="color: rgb(128, 175, 16); text-decoration:line-through;">              </pre><br/>
	<p>Il est important pour nous de récolter vos recommandations et vos conseils afin d'ameliorer la qualité de nos services.</p>
	<p><img width="800" src="sprites/votre_avis.jpg" /></p>
</section>
<?php
