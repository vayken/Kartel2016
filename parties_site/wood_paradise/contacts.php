...
<html>
    ...
    <body>
	    ...
	    <section id="main_page" style="height: 950px;">
			    <p style="padding-right: 30px; padding-left: 30px;"><strong>The Wood Paradise</strong> <br/>
			    77110 MEAUX
			    </p>
			    <p style="padding-right: 30px; padding-left: 30px;"><span style="color: rgb(128, 175, 16);" >TEL: 06.60.13.50.63
			    </span></p>
			    <p style="padding-right: 30px; padding-left: 30px;"><span style="color: rgb(159, 168, 164);" >E-Mail : <br/> info@WoodParadise.fr</span>
			    </p>
			    <p><img style="width: 560px; height: 610px;" src="sprites/france.png" /></p>
